from plus import ky_bilibili_plus
...
if __name__ == '__main__':
    # 第一种方法
    all_songs = ky_bilibili_plus.get_all_audio_by_favorite("1598050455")
    ...
    # 第二种方法
    # all_movies = ky_bilibili_plus.get_all_selections_by_one_movie("https://www.bilibili.com/video/BV1GE411R7sE")
